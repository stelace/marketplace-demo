  ...
  return {
    ...
    build: {
      ...
      env: {
        ...
        VUE_APP_MARKETPLACE_TYPE: process.env.VUE_APP_MARKETPLACE_TYPE,
        VUE_APP_ORDER_FEE_TYPES: process.env.VUE_APP_ORDER_FEE_TYPES,
        ...
        NETLIFY_FUNCTION_CREATE_ORDER: process.env.NETLIFY_FUNCTION_CREATE_ORDER,
      }
    },
